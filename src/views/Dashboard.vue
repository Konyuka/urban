...
<div class="h-screen flex overflow-hidden bg-white">
  ...
  <div class="hidden lg:flex lg:flex-shrink-0">
    <div class="flex flex-col w-52">
      ...
      <div class="flex flex-col h-0 flex-1 border-r border-gray-200 bg-gray-100 shadow-2xl">
        <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
          ...
          <nav class="mt-5 flex-1" aria-label="Sidebar">
            <div class="px-2 space-y-1">
              ...
              <a href="#" class="hover:bg-gray-50 hover:text-gray-900 text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                <!-- Current: "text-gray-500", Default: "text-gray-400 group-hover:text-gray-500" -->
                <!-- Heroicon name: home -->
        ...
        <div class="flex-shrink-0 flex border-t border-gray-200 p-4">
          ...
          <a href="#" class="flex-shrink-0 w-full group block">
            <div class="flex items-center justify-between">
              <div class="mr-6">
                <p class="text-xs font-medium text-green-500 group-hover:text-gray-700">
                  Online
                </p>
              </div>
               <div @click="logout" class="flex justify-between ml-4">
                 <svg class="w-6 h-6 text-red-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path></svg>
                 <span class="mt-1 text-xs font-medium text-gray-500 group-hover:text-gray-700">Logout</span>
              </div>
            </div>
          </a>
  ...
  <div class="flex flex-col min-w-0 flex-1 overflow-hidden">
    ...
    <div class="flex-1 relative z-0 flex bg-blue-100 wrapper">
